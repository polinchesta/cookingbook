...
{
    public partial class Poldnik : Form
    {
        ...
        public Poldnik(User currentUser) : this()
        {
        ...
        private void GetName(string name)
        {
            ...
            while (reader.Read())
            {
                poldnik1.Text = reader[1].ToString();
                poldnik_sostav1.Text = reader[2].ToString();
                poldnik_recept1.Text = reader[3].ToString();
        ...
        {
            poldnik1.Visible = true;
            poldnik_sostav1.Visible = true;
            poldnik_recept1.Visible = true;
        ...
        {
            poldnik1.Visible = false;
            poldnik_sostav1.Visible = false;
            poldnik_recept1.Visible = false;
        ...
        Point lastPoint;
        private void Poldnik_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void Poldnik_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        {
            string path = @"C:\Users\Полина\Desktop\cookingbook-main\Projectforkyrs\Projectforkyrs\Resources\Video\" + poldnik1.Text + ".mp4";
            Process.Start(path);
        }
    }
}
